...
```sh
docker run --rm -v $PWD:/tmp ghcr.io/degauss-org/census_block_group:1.1.1 my_address_file_geocoded.csv
```

will produce `my_address_file_geocoded_census_block_group_1.1.1_2010.csv` with added columns:
...
```sh
docker run --rm -v $PWD:/tmp ghcr.io/degauss-org/census_block_group:1.1.1 my_address_file_geocoded.csv 1990
```

will produce `my_address_file_geocoded_census_block_group_1.1.1_1990.csv`, with columns called **`census_block_group_id_1990`** and **`census_tract_id_1990`**.
